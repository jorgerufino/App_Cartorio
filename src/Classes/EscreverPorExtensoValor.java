 ...
 *
 */
public class EscreverPorExtensoValor {
	...
	private static EscreverPorExtensoValor instance = null;
	
	public static EscreverPorExtensoValor getInstance() {
		if (instance == null) {
			instance = new EscreverPorExtensoValor();
		}

		return instance;
	}
	
	public EscreverPorExtensoValor() {

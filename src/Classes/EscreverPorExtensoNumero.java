 ...
 *
 */
public class EscreverPorExtensoNumero {
	...
	private static final String MOEDA_SINGULAR = "";
	private static final String MOEDA_PLURAL = "";
	
	private static final String FRACAO_SINGULAR = "";
	private static final String FRACAO_PLURAL = "";
	...
	private static EscreverPorExtensoNumero instance = null;
	
	public static EscreverPorExtensoNumero getInstance() {
		if (instance == null) {
			instance = new EscreverPorExtensoNumero();
		}

		return instance;
	}
	
	public EscreverPorExtensoNumero() {
